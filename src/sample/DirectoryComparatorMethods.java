 ...
 */
class DirectoryComparatorMethods {
     ...
     */
    static void printFileInfo(String arg) throws FileNotFoundException {
        File f = new File(arg);
     ...
     * @throws FileNotFoundException
     */
    static void compareTwoFiles(String arg1, String arg2) throws FileNotFoundException {
     ...
     * @throws FileNotFoundException
     */
    static void printCheckSum(String arg) throws FileNotFoundException {
        File f = new File(arg);
        if (f.exists() && f.isFile()) {
     ...
     * @throws FileNotFoundException
     */
    static void compareFilesByContents(String arg1, String arg2) throws FileNotFoundException {
        File f1 = new File(arg1);
        File f2 = new File(arg2);
     ...
     * @throws FileNotFoundException
     */
    static void printFolderContents(String dir, boolean recursively) throws FileNotFoundException {
        File f = new File(dir);
     ...
     * @throws FileNotFoundException
     */
    static String compareTwoFolders(String arg1, String arg2) throws FileNotFoundException {
...
//                    System.out.printf("Missing in second folder structure: %s\n", fileOne);
                    sb.append(String.format("Missing in second folder structure: %s\n", fileOne));
...
//                    System.out.printf("Missing in first folder structure: %s\n", fileTwo);
                    sb.append(String.format("Missing in first folder structure: %s\n", fileTwo));
                    n2++;
                }
            }
...
//            System.out.printf("Error: %s or %s does not exist.\n", f1.toString(), f2.toString());
            sb.append(String.format("Error: %s or %s does not exist.\n", f1.toString(), f2.toString()));
        }
        return sb.toString();
    }
